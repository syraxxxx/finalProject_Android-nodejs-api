...
INSERT INTO site 
VALUES 
    (null, 'Rova Manjakamiadana', 'Le Rova Manjakamiadana est le palais royal de Madagascar situé à Antananarivo. Il est un symbole historique et culturel du pays.', 'rova', 'rova.mp4', 1),
    (null, 'Avenue de l''Indépendance', 'L''Avenue de l''Indépendance est une célèbre avenue à Antananarivo, bordée de bâtiments historiques et de boutiques.', 'avenue_independence', 'avenue_independence.mp4', 1),
    (null, 'Parc national de l''Isalo', 'Le Parc national de l''Isalo est un parc naturel magnifique, connu pour ses canyons, ses piscines naturelles et sa faune unique.', 'isalo', 'isalo.mp4', 1),
    (null, 'Parc national de Ranomafana', 'Le Parc national de Ranomafana est une réserve de forêt tropicale qui abrite une diversité d''espèces de lémuriens et d''oiseaux.', 'ranomafana', 'ranomafana.mp4', 1),
    (null, 'Baie de Diego Suarez', 'La Baie de Diego Suarez est une magnifique baie entourée de formations rocheuses, offrant une vue panoramique.', 'diego_suarez', 'diego_suarez.mp4', 1),
    (null, 'Tsingy de Bemaraha', 'Le Tsingy de Bemaraha est un site géologique unique avec ses formations de calcaire en forme d''aiguilles.', 'tsingy_bemaraha', 'tsingy_bemaraha.mp4', 1),
    (null, 'Réserve spéciale d''Ankarana', 'La Réserve spéciale d''Ankarana est une réserve naturelle avec ses grottes, ses lacs souterrains et ses tsingy.', 'ankarana', 'ankarana.mp4', 1),
    (null, 'Île de Nosy Be', 'L''île de Nosy Be est une île paradisiaque avec ses plages de sable blanc, ses eaux turquoise et sa biodiversité marine.', 'nosy_be', 'nosy_be.mp4', 1),
    (null, 'Parc national de l''Andringitra', 'Le Parc national de l''Andringitra est un parc montagneux qui offre des randonnées spectaculaires et des vues panoramiques.', 'andringitra', 'andringitra.mp4', 1),
    (null, 'Allée des Baobabs', 'L''Allée des Baobabs est une route bordée de majestueux baobabs, offrant un paysage emblématique de Madagascar.', 'allee_baobabs', 'allee_baobabs.mp4', 1);
